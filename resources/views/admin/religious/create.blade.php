...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ route('religious-occasion.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" id="occasion" name="occasion" placeholder="Occasion Details" rows="4">{{ old('occasion') }}</textarea>
                                @error('occasion')
                                    <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
